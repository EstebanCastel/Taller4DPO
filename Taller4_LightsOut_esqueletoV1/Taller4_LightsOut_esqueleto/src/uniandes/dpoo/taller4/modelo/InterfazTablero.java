...
public class InterfazTablero extends JPanel implements MouseListener {
    ...
    public void mousePressed(MouseEvent e) {
        ...
        if (tablero.tableroIluminado()) {
            ...
            JOptionPane.showMessageDialog(null, "Felicitaciones ha completado el juego, su puntaje es: " + puntaje);
            
            if (top10.esTop10(puntaje)) {
                String nombre = nombreJugador;
                top10.agregarRegistro(nombre, puntaje);
                try {
                    top10.salvarRecords(Top10.str2File("C:\\Users\\esteb\\OneDrive\\Desktop\\Taller4_LightsOut_esqueletoV1\\Taller4_LightsOut_esqueleto\\data\\top10.csv"));
